...
import {CompanyProfilePutForm } from "./CompanyProfilePutForm";
import logo from '../imagenes/logo-navbar.png';
export const FormPutCompanyProfile = () => {
